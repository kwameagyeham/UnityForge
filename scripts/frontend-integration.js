 ...
 * This file demonstrates how to integrate Unityforge with a web frontend
 */

// For React/Vue/Angular applications
export class UnityforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new UnityforgeClient(provider, contractAddress);
